...
def draw_rectangle(image_np, p1, p2, color_1,score,thickness):
    ...
    cv2.putText(image_np, "Person {}%".format(conf), p1, cv2.FONT_ITALIC , 0.5, (255, 255, 0), 1)


def show_count_persons(image_np, count_p,im_height):
    cv2.putText(image_np, "Number of persons: {}".format(count_p), (10, im_height - 40), cv2.FONT_ITALIC , 0.75,
                (0, 255, 255), 2)


def show_close_persons(image_np, close_p, im_height):
    cv2.putText(image_np, "Number of close persons: {}".format(close_p), (10, im_height - 15), cv2.FONT_ITALIC , 0.75,
                (0, 0, 255), 2)
